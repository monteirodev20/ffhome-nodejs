...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicGVyZWlyYTIwIiwiYSI6ImNrejE3bW14NDFqY2MydmxybXBoYXg3dG0ifQ.lZVqXttcor2NFVIB7DCg_Q';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51KULYtEijdBsvZ9QrHHw5hBWBFTWonFOLwZ9IwK7h10vIvtXxiHLeXoREztOiHomzXUGum0jgBhJL2GA6MpoVIfa008bJD1OEu'); // 1) Get checkout session from API
          ...
          case 4:
            ...
            console.log(session); // 2) Creat checkout from + chance credit card
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    e.preventDefault();
    document.querySelector('.btn--green--Create').textContent = 'Creating...';
